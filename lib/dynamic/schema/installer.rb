  ...
  module Schema
    class Installer
      ...
      def self.generate_migration
        File.open(Rails.root.join('db', 'migrate', 'create_dynamic_records.rb'), 'w') do |r|
          f.write('class CreateDynamicRecords < ActiveRecord::Migration[5.1]')
